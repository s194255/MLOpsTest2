...
def train(lr, epochs):
    ...
    classifier = Classifier(hidden_dim=30)
...
def evaluate(model_checkpoint):
    ...
    main = Main(models, dataloaders, optimizer, scheduler, criterion, save_path='models/trained_model.pt', weight_path=model_checkpoint)
    main.test()
